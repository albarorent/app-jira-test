...
function TabsNavigator() {
  return (
    ...
    >
      <Tab.Screen name="Inicio" initialParams={{ id: 'homeTab' }} component={Dashboard} />
      <Tab.Screen name="MyTasks" initialParams={{ id: 'mytaskTab' }} component={Assignments} />
      <Tab.Screen name="Settings" initialParams={{ id: 'settingsTab' }} component={Settings} />
    </Tab.Navigator>
  );
}
